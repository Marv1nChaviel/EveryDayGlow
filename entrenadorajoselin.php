...
<div class="container-btn-flotante">
    ...
    <div class="card-curriculum" style="box-shadow: 0 0 15px gray;">
        ...
        <div class="description-curriculum">
            <h3>Joselin Gonzalez</h3>
            <h4>Entrenadora de Yoga</h4>
            <p>Instructora de Yoga altamente motivada y enérgica; con un profundo conocimiento sobre asanas, así como técnicas de relajación y respiración. <br> ¡Te invito a inscribirte conmigo para llevar un estilo de vida saludable!</p>
            <h4>Cursos</h4>
            <p>Certificación de primeros auxilios y RCP. <br>Formación de 500 horas de Yoga. <br> Profesora de Yoga certificada.</p>
            <h4>Experiencia Laboral</h4>
            <p>Clases de Pilates y Yoga nivel principiante e intermedio. <br> Meditación guiada <br> </p>
        ...
        window.onload = ()=>{
            ...
            bottonFlotante.addEventListener('click',(e)=>{
                ...
                if(e.target.classList[0] === 'button-enviar-ventana-ws' || e.target.classList[0] === 'icono-boton-enviar'){
                    ventana.style.display="none";
                    window.open("https://wa.me/584246801987", '_blank');
                }            
            });
        }
    </script>
