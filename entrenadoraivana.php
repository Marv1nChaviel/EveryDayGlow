...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home" style="position: relative;">
    ...
    <div class="card-curriculum" style="box-shadow: 0 0 15px gray;">
        ...
        <div class="description-curriculum">
            <h3>Ivana Moreno</h3>
            <p>Instructora certificada y orientada al rendimiento que sobresale en la coreografía de movimientos de acondicionamiento físico. <br> ¡La motivación es lo que te pone en marcha, y el hábito es lo que hace que sigas!</p>
            <h4>Cursos</h4>
            <p>Certificado en Aqua Zumba. <br> Certificado en Zumba kids nivel principiante. <br> Certificado en Zumba gold nivel intermedio.</p>
            <h5>Experiencia Laboral</h5>
            <p>Coreografa en Cardio Dance Fitness. <br> </p>
    ...
    <script>
        ...
        //Script del botoncito by Juan de Nadie <3
        window.onload = ()=>{
            ...
            bottonFlotante.addEventListener('click',(e)=>{
                ...
                if(e.target.classList[0] === 'button-enviar-ventana-ws' || e.target.classList[0] === 'icono-boton-enviar'){
                    ventana.style.display="none";
                    window.open("https://wa.me/584246277768", '_blank');
                }            
            });
        }
        //Fin del botoncito by Juan de Nadie <3
    </script>
